...
<body style=" background-image:url(lib567.jpg); background-size:1095px;">
<script>
...
<div id="user" class="col-md-12" >
  <div class="panel panel-primary panel-table animated slideInDown">
   <div class="panel-heading " style="padding:5px; background-color:#a446d2;">
        <div class="row" >
        
        <div  style="margin-left:1px; align-content:center; text-align:center;">
            <h1  style=" text-align:center"> Issued Books list</h1>
        </div>
        </div>
    </div>
   <div class="panel-body">
     <div class="tab-content">
      <div role="tabpanel" class="tab-pane active" id="list">
       <table class="table table-striped table-bordered table-list" bordercolor="#a446d2">
        <thead>
         <tr>
              <th>Issueid</th>
              <th>category</th>
